...
//                .meta("method", "GET"));
        addSeed(new CrawlDatum("http://www.sydjsh.cn/search.do?http://www.sydjsh.cn/search.do?keyword=%E4%B8%8A&type=12&geo_code=")
                .meta("method", "POST")
//                .meta("keyword", "上")
//                .meta("type","")
//                .meta("geo_code","")
...
//        request.addHeader("keyword", "上");
//        request.addHeader("type","");
//        request.addHeader("geo_code","");
//        request.addHeader("pageIndex","1");
